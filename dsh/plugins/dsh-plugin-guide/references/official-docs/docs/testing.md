...
- **Real-API e2e** (`pnpm run test:e2e`): with-key tests against the live DeepSeek model; web-search tests use the local SearXNG instance and require no external search-provider key.
