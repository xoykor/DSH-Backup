/**
 * Build faces for dsh-budget. The node half (src/index.ts + the hand-written
 ...
 * node half serves under /plugins/dsh-budget/client.js.
 *
...
export default defineConfig([
  {
    ...
    target: 'es2024',
    dts: false,
    // `scripts/prepare.mjs` wipes lib/ up front; tsdown clean stays off so the
    // tsc declarations emitted first survive the bundle step.
    clean: false,
