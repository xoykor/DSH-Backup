#!/usr/bin/env node
/**
 * Release automation for dsh-fast.
 *
 ...
 *      tag (message: `dsh-fast v<version>`).
 *
 ...
 *
 * @module dsh-fast/scripts/release
 */
...
if (versionLine.exec(versionSource) === null) {
...
git('tag', '-a', `v${version}`, '-m', `dsh-fast v${version}`)
