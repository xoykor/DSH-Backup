...
2. Rode `scripts/validate_pptx.py --input RESULT.pptx --render-dir render/`. O helper valida o ZIP/XML, procura marcadores restantes e, quando `soffice` existe, converte a apresentação em PDF para inspeção visual.
