...
Every turn has hard executor budgets: 48 steps, 48 tool calls, 15 minutes, and 120,000 high-water tokens by default. These counters include different tools in the same investigation and are reset only by a new user turn; compaction cannot renew them.
